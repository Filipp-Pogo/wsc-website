...
const thisWeekItems = [
  {
    icon: Calendar,
    tag: "Event",
    title: "Tier 1 Junior Tennis Showcase",
    desc: "Watch our junior academy players compete in an inter-squad exhibition. Families welcome.",
  ...
  },
  {
    icon: Clock,
    tag: "Open Play",
    title: "Extended Pickleball Hours",
    desc: "The Dome is open late this week — evening open play sessions added through Friday.",
    date: "Mon – Fri",
  ...
  },
  {
    icon: Calendar,
    tag: "Registration",
    title: "Summer Training Early Bird Ends March 15",
    desc: "Register by March 15 for 10% off any full-week summer program plus a free WSC t-shirt.",
